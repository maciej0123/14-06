...
<div class="container">
    ...
    <div class="main-content">
        ...
        if(isset($_GET['id'])) {
            ...
            $sql = "SELECT Nr_czytelnika  AS ID, 
                    Imie, 
                Nazwisko, 
                Miasto, 
                Kod,
                ...
                Nr_legitymacji,
                Funkcja,
                Plec FROM czytelnicy WHERE Nr_czytelnika  = $id";
            ...
            if ($t === 'ksiazki') {
                ...
                $sql = "SELECT Id_stanowisko as ID,
                Nazwa FROM stanowiska WHERE Id_stanowisko = $id";
            }
                        ...
                        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                            ...
                            if ($t === 'czytelnicy') {
                                ...
                                $sql = "UPDATE czytelnicy SET 
                                    ...
                                    Ulica = '$ulica',
                                    Kod = '$Kod',
                                    Data_zapisania = '$Data_zapisania',
                                    Data_skreslenia = '$Data_skreslenia',
                                    Nr_legitymacji = '$Nr_legitymacji',
                                    Funkcja = '$Funkcja',
                                    Plec = '$Plec'

                                WHERE Nr_czytelnika = $id";
                                // ksiazki
                            } else if ($t === 'ksiazki') {
                                $imie = $_POST['Imię'];
                                $nazwisko = $_POST['Nazwisko'];

...
foreign key FK_STANOW_PRACOW (Id_stanowisko)
references Stanowiska (Id_stanowisko));
...
Cena Decimal(10,2),
Id_dzial integer,
foreign key FK_DZIALY_KSIAZKI (Id_dzial)
...
Data_zwrotu date,
foreign key FK_PRACOW_WYPOZ (Id_pracownika)
references Pracownicy (Id_pracownika),
foreign key FK_WYPOZ_KSIAZKI (Sygnatura)
references Ksiazki (Sygnatura),
foreign key FK_CZYT_WYPOZ (Nr_czytelnika)
references Czytelnicy (Nr_czytelnika));
...
INSERT INTO ksiazki values (null,'Uwarunkowania i plany rozwoju turystyki','Mlynarczyk','Zygmunt','Wydawnictwo Naukowe UAM','Warszawa','2008','100','49','2');
INSERT INTO ksiazki values (null,'Ekspresja receptorow sterydowych','Skrzypczak','Maciej','Wydawnictwo Naukowe UAM','Warszawa','2008','121','115','1');
...
INSERT INTO ksiazki VALUES (null, 'Pan Tadeusz','Mickiewicz','Adam','PWN','Warszawa','1945','300','70','7');
INSERT INTO ksiazki VALUES (null, 'Programowanie','Matejek','Roman','PWN','Warszawa','1995','100','79','1');
INSERT INTO ksiazki VALUES (null, 'Grafika','Malas','Grzegorz','PWN','Warszawa','1999','105','155','1');
INSERT INTO ksiazki VALUES (null, 'Programowanie obiektowe','Matejek','Roman','PWN','Warszawa','1995','100','79','1');
INSERT INTO Ksiazki Values (null,'100 najwiekszych osiagniec medycyny', 'Eugene', 'Straus W.', 'Swiat Ksiazki','Poznan',2003,491,112,8);

INSERT INTO Ksiazki Values (null, 'Atlas Ptakow', 'Hecker','Frank', 'RM','Krakow',1999,189,72,9);

INSERT INTO Ksiazki Values (null, 'Geografia Fizyczna Polski', 'Richling', 'Andrzej', 'PWN','Warszawa',2005,200,115,9);

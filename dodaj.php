        ...
        <div class="container2">
            <form action="" method="POST">
                ...
                if ($t === 'ksiazki') {
                    ...
                    $array = array('Imie', 'Nazwisko', 'Data_ur', 'Ulica', 'Kod', 'Miasto', 'Data_zapisania', 'Data_skreslenia', 'Nr_legitymacji', 'Funkcja', 'Plec');
                }
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                if ($t === 'czytelnicy') {
                    ...
                    $Kod = $_POST['Kod'];
                    $Miasto = $_POST['Miasto'];
                    $Data_zapisania = $_POST['Data_zapisania'];
                    $Data_skreslenia = $_POST['Data_skreslenia'];
                    $Nr_legitymacji = $_POST['Nr_legitymacji'];
                    $Funkcja = $_POST['Funkcja'];
                    $Plec = $_POST['Plec'];

                    $sql = "INSERT INTO czytelnicy1 (Imie, Nazwisko, Data_ur, Ulica, Kod, Miasto, Data_zapisania, Data_skreslenia, Nr_legitymacji, Funkcja, Plec) 
                            VALUES ('$imie', '$nazwisko', '$data_ur', '$ulica', '$Kod', '$Miasto', '$Data_zapisania', '$Data_skreslenia', '$Nr_legitymacji', '$Funkcja', '$Plec')";
                } else if ($t === 'ksiazki') {
                    $tytul = $_POST['Tytul'];
                    $imie = $_POST['Imie'];
                    $nazwisko = $_POST['Nazwisko'];
